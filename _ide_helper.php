...
namespace {
    ...
    class Minify extends \CeesVanEgmond\Minify\Facades\Minify{
        ...
        public static function javascript($file, $attributes = array()){
            return \CeesVanEgmond\Minify\Minify::javascript($file, $attributes);
        }
        ...
        public static function stylesheet($file, $attributes = array()){
            return \CeesVanEgmond\Minify\Minify::stylesheet($file, $attributes);
        }
        ...
        public static function javascriptDir($dir, $attributes = array()){
            return \CeesVanEgmond\Minify\Minify::javascriptDir($dir, $attributes);
        }
        ...
        public static function withFullUrl(){
            return \CeesVanEgmond\Minify\Minify::withFullUrl();
        }
